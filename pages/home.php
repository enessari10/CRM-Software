...
<html lang="tr">
  ...
  <link rel="stylesheet" type="/text/css" href="/style.css?<?php echo time(); ?>" />
    ...
    <title>Mikroes Bilişim - CRM </title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="container-fluid d-flex justify-content-between">
              ...
              <span class="float-none float-sm-end mt-1 mt-sm-0 text-end"> Copyright <a href="https://www.mikroes.com/" target="_blank"> Mikroes  Bilişim ve Danışmanlık Hizmetleri </a>2022</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
